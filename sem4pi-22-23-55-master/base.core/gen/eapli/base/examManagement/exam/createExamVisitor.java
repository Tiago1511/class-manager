...
public interface createExamVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link createExamParser#question_section}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQuestion_section(createExamParser.Question_sectionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link createExamParser#mc_question_block}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMc_question_block(createExamParser.Mc_question_blockContext ctx);
	/**
	 * Visit a parse tree produced by {@link createExamParser#tf_question_block}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTf_question_block(createExamParser.Tf_question_blockContext ctx);
	/**
	 * Visit a parse tree produced by {@link createExamParser#ta_question_block}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTa_question_block(createExamParser.Ta_question_blockContext ctx);
	/**
	 * Visit a parse tree produced by {@link createExamParser#mc_question}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMc_question(createExamParser.Mc_questionContext ctx);
	/**
	 * Visit a parse tree produced by {@link createExamParser#mc_answer_block}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMc_answer_block(createExamParser.Mc_answer_blockContext ctx);
	/**
	 * Visit a parse tree produced by {@link createExamParser#mc_answer}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMc_answer(createExamParser.Mc_answerContext ctx);
	/**
	 * Visit a parse tree produced by {@link createExamParser#tf_question}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTf_question(createExamParser.Tf_questionContext ctx);
	/**
	 * Visit a parse tree produced by {@link createExamParser#ta_question}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTa_question(createExamParser.Ta_questionContext ctx);
}