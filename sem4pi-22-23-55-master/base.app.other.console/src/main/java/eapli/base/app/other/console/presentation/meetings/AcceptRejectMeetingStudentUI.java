...
public class AcceptRejectMeetingStudentUI extends AbstractUI {

    private static final Logger LOGGER = LogManager.getLogger(AcceptRejectMeetingStudentUI.class);
