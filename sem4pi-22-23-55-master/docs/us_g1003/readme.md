...
*In this task, As Manager, I want to open and close enrollements in courses*
...
**US G1003**As Manager, I want to open and close enrollements in courses

- G1003.1. Solution design

- G1003.2. Solution implementation

*Regarding this requirement, we understand that it is a matter of opening or closing enrollements a course, taking into account the previous status of the course.*
...
- To open enrollements the course, it must be in the open state.
- To close enrollements the course, it must be in the enroll state.
...
Controller: OpenEnrollCourseController, CloseEnrollCourseController
...
![SD](Open%20Enrroll%20Course.svg "A sequence diagram")
![SD](Close%20Enroll%20Diagram.svg "A sequence diagram")
...
![controller](Controller%20Open.png "controller")
![controller](Controller%20Close.png "controller")

## 6. Integration/Demonstration

![SSD](Open%20Enroll%20Course%20ssd.svg "A sequence diagram")
![SSD](Close%20Enroll%20Course%20ssd.svg "A sequence diagram")
